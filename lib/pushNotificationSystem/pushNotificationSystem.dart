...
class PushNotificationSystem{
    ...
    openAppAndShowNotificationData(receiverID, senderID, context)async{
      await FirebaseFirestore.instance.collection("Users")
          .doc(senderID).get().then((snapshot){
            String profileImage = snapshot.data()!["image"].toString();
            ...
            String professions = snapshot.data()!["profession"].toString();
    ...
    notificationDialogBox(senderID,
        profileImage,
        name,
        age,
        city,
    ...
    Future generationDeviceRegistrationToken()async{
